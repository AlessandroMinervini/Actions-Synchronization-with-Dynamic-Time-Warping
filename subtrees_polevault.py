...
# SELECT SUBTREE (node id+1, you can find ids in child_polevault.csv)
subtree = sub_structs[0:267]

# COMPUTE PATHS AND SHOW FRAMES OF SUBTREE  show = 1 don't showframes
samples, sub_structs = functions.stretch_and_show_subtrees(subtree, n_leafs, childs, finalAnnots, sport_folder, names, show=1)
